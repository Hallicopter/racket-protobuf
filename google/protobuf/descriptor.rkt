...
(define-message-type
 ...
 ((optional primitive:string name 1)
  ...
  (repeated primitive:int32 public-dependency 10)
  (repeated primitive:int32 weak-dependency 11)
...
(define-message-type
 ...
 ((optional primitive:string name 1)
  ...
  (repeated struct:oneof-descriptor-proto oneof-decl 8)
...
(define-message-type
 ...
 ((optional primitive:string name 1)
  ...
  (optional primitive:int32 oneof-index 9)
...
(define-message-type
 ...
 ((optional primitive:string java-package 1)
  ...
  (optional primitive:bool java-string-check-utf8 27 #f)
  (optional enum:file-options:optimize-mode optimize-for 9 'speed)
  (optional primitive:string go-package 11)
  ...
  (optional primitive:bool deprecated 23 #f)
...
(define-message-type
 ...
 ((optional enum:field-options:ctype ctype 1 'string)
  ...
  (optional primitive:bool lazy 5 #f)
  (optional primitive:bool deprecated 3 #f)
  (optional primitive:string experimental-map-key 9)
  (optional primitive:bool weak 10 #f)
  (repeated struct:uninterpreted-option uninterpreted-option 999)))
(define-enum-type field-options:ctype ((string 0) (cord 1) (string-piece 2)))
(define-message-type
 enum-options
 ((optional primitive:bool allow-alias 2)
  (optional primitive:bool deprecated 3 #f)
  (repeated struct:uninterpreted-option uninterpreted-option 999)))
(define-message-type
 enum-value-options
 ((optional primitive:bool deprecated 1 #f)
  (repeated struct:uninterpreted-option uninterpreted-option 999)))
(define-message-type
 service-options
 ((optional primitive:bool deprecated 33 #f)
  (repeated struct:uninterpreted-option uninterpreted-option 999)))
(define-message-type
 method-options
 ((optional primitive:bool deprecated 33 #f)
...
(define-message-type
 ...
 ((packed primitive:int32 path 1)
  (packed primitive:int32 span 2)
  (optional primitive:string leading-comments 3)
  (optional primitive:string trailing-comments 4)))
